...
export function ParticipantDashboard() {
    ...
    // Modification de la fonction loadDashboardData pour mieux gérer l'absence de challenge
    async function loadDashboardData() {
        try {
            ...
            console.log("Niveau de l'utilisateur:", userData.current_level);

            // Vérifier si le niveau de l'utilisateur est défini
            if (!userData.current_level) {
                console.warn("L'utilisateur n'a pas de niveau défini");
                // Définir un niveau par défaut si nécessaire
                ...
                if (updateLevelError) {
                    console.error("Erreur lors de la mise à jour du niveau:", updateLevelError);
                    throw updateLevelError;
                }
            ...
            if (!challengeData) {
                console.log("Aucun challenge trouvé pour le niveau actuel, recherche de challenges actifs...");
                ...
                if (anyActiveChallenge) {
                    console.log("Challenge actif trouvé d'un autre niveau:", anyActiveChallenge);
                    // Optionnel: mettre à jour le niveau de l'utilisateur pour correspondre au challenge trouvé
                    ...
                    setActiveChallenge(anyActiveChallenge);
                } else {
                    console.log("Aucun challenge actif trouvé dans la base de données");
