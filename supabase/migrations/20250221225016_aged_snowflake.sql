/*
  # Fix security policies to prevent recursion
  
  This migration:
  1. Drops all existing policies to start fresh
  2. Creates new policies using auth.jwt() for role checks
  3. Implements proper role-based access control without recursion
*/
